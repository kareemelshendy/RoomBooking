          ...
          <div className={styles.form_container}>
            ...
            <form action="" onSubmit={handleSubmit(buttonHandler)}>
              ...
              <div className="mb-3">
                ...
                <textarea {...register("comments", { required: "يجب إدخال الملاحظات" })} className={`form-control ${styles.comments}`} name="comments" placeholder="أدخل الملاحظات"></textarea>
                {errors.comments && <span className={styles.error}>{errors.comments.message}</span>}
              </div>
              <div className={styles.button}>
                <Button bgColor="btn-primary" type="submit" width="w-100" padding="btn-p">
                  حجز
                </Button>
              </div>
            </form>
