...
import { PendingReservationsHOC } from "../../hoc/reservations-hoc/pending-hoc/pending-reservations-hoc"
import { Room } from "../../models"

const PendingReservations = ({ rooms }: { rooms: Room[] }) => {
  return (
    <Layout title="قيد الإنتظار">
